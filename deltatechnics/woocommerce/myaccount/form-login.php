...
<div class="tabs">
	<form class="woocommerce-form woocommerce-form-login login modal__form log-active tabs__wrap" method="post" id="login-form">

		<?php do_action( 'woocommerce_login_form_start' ); ?>

		<div class="modal__login">
			<h3 class="form__title" id="demo"><?php esc_html_e( 'Login', 'woocommerce' ); ?></h3>

			<div class="form__item">
				<input id="formMail" type="email" name="username" id="username" placeholder="<?php esc_html_e( 'Email address', 'woocommerce' ); ?>" class="form__input _req _email" autocomplete="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>" /><?php // @codingStandardsIgnoreLine ?>
			</div>

			<div class="form__item">
				<input id="formPass" type="password" name="password" id="password" placeholder="<?php esc_html_e( 'Password', 'woocommerce' ); ?>" class="form__input form__input--lock _req _pass" autocomplete="current-password">
				<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>" class="form__forgot-pass"><?php esc_html_e( 'Lost your password?', 'woocommerce' ); ?></a>
			</div>
			...
			<div class="form__btn">
				...
				<button type="submit" class="form__btn_button" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>"><?php esc_html_e( 'Log in', 'woocommerce' ); ?></button>
			</div>

			<div class="form__btn form__btn-item form__btn_button--reg" id="reg-form-show">
				<a href="#reg-form" class="tabs__item"><?php esc_html_e( 'Register', 'woocommerce' ); ?></a>
			</div>
	...
	<form method="post" class="woocommerce-form woocommerce-form-register register modal__form tabs__wrap" <?php do_action( 'woocommerce_register_form_tag' ); ?> id="reg-form">
		<div class="modal__login">
			...
			<div class="form__btn form__btn-item form__btn_button--reg login-form-show" id="login-form-show">
				<a href="#login-form" class="tabs__item">Увійти</a>
			</div>
